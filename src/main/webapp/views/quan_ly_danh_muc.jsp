...
<script src="resources/js/pages/ajax_model_category.js"></script>
...
<main>
    ...
    <div class="tool-page">
        <div class="container">
            <div class="row">
                <div class="col-md-8">
                    <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal" id="btn-them-danh-muc"><i class="fas fa-plus"></i> Thêm danh mục sản phẩm</button>
                </div>
                    ...
                    <div class="table-reponsive">
                        <table class="table table-bordered">
                            ...
                            <tr>
                                ...
                                <td>Mark</td>
                                <td class="text-center">
                                    <button type="button" class="btn btn-warning mt-1" data-toggle="modal" data-target="#exampleModal" id="btn-sua-danh-muc"><i class="fas fa-pencil-alt"></i> Sửa</button>
                                    <button type="button" class="btn btn-danger mt-1"  data-toggle="modal" data-target="#exampleModal1" id="btn-xoa-danh-muc"><i class="fas fa-trash-alt"></i> Xóa</button>
                                </td>
                            </tr>
                            <tr>
                                <th scope="row">2</th>
